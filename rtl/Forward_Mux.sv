...
module Forward_Mux (
    ...
    //data from wb stage
    input logic [31:0] rs1_fw_wb_data,
    input logic [31:0] rs2_fw_wb_data,
    
    //selection from fw control
    ...
    always_comb begin
        case (fw_rs1_sel_in)
            ...
            RS1_FW_WB: fw_mux_rs1_data_out = rs1_fw_wb_data;
    ...
    always_comb begin
        case (fw_rs2_sel_in)
            ...
            RS2_FW_WB: fw_mux_rs2_data_out = rs2_fw_wb_data;
